#!/bin/sh
# Created by https://www.xforce-vpn.cf
# Modified by XFORCE VPN
...
# install screenfetch
cd
wget -O /usr/bin/screenfetch "https://raw.githubusercontent.com/venzaba/debian-ssl/master/screenfetch"
...
wget https://raw.githubusercontent.com/venzaba/debian-ssl/master/vnstat_php_frontend-1.5.1.tar.gz
...
wget -O /etc/stunnel/stunnel.pem "https://raw.githubusercontent.com/venzaba/debian-ssl/master/stunnel.pem"
wget -O /etc/stunnel/stunnel.conf "https://raw.githubusercontent.com/venzaba/debian-ssl/master/stunnel.conf"
...
# install mrtg
wget -O /etc/snmp/snmpd.conf "https://raw.githubusercontent.com/venzaba/debian-ssl/master/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://raw.githubusercontent.com/venzaba/debian-ssl/master/mrtg-mem.sh"
...
curl "https://raw.githubusercontent.com/venzaba/debian-ssl/master/mrtg.conf" >> /etc/mrtg.cfg
...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/venzaba/debian-ssl/master/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/venzaba/debian-ssl/master/badvpn-udpgw64"
fi
...
# setting banner
rm /etc/issue.net
wget -O /etc/issue.net "https://raw.githubusercontent.com/venzaba/debian-ssl/master/issue.net"
...
# download script
cd
wget https://raw.githubusercontent.com/venzaba/debian-ssl/master/install-premiumscript.sh -O - -o /dev/null|sh
...
echo "                         Copyright 2018. XFORCE VPN                             "
echo "                        https://www.xforce-vpn.cf                               "
echo "               Created By Steven Indarto(fb.com/stevenindarto2)                 "
echo "                                Modified by XFORCE VPN                          "
echo "--------------------------------------------------------------------------------"
